...
const Alert = ({modalBtnOnClick, alertText}) => {
  return (
    <div className="fixed top-15 left-1/2 transform -translate-x-1/2 bg-white px-6 py-4 rounded-lg shadow-lg flex items-center justify-between w-[350px] sm:w-[550px]">
